...
import LTCData, { LTCMeun, LTCState } from "./LTCData/Data";
      ...
      <div className="max-w-screen shadow-md rounded-lg min-h-20 bg-primary">
        <div className="flex p-2">
          <div className="grow text-center">
            <Meun data={LTCState.Levels} type="level" />
          </div>
          <div className="grow text-center">
            <Meun data={LTCState.Types} type="types" />
          </div>
          <div className="grow text-center">
            <Meun data={LTCState.Other} type="other" />
          </div>
        </div>
      </div>
    </section>
...
const Footer: React.FC = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-primary shadow-md text-sm">
